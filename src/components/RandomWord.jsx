// src/components/RandomWord.jsx
'use client';

import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faVolumeUp } from '@fortawesome/free-solid-svg-icons';

export default function RandomWord({ word }) {
  const speak = () => {
  ...
  return (
    <div className="card p-3 bg-white shadow-md rounded-lg flex flex-col h-full max-w-[200px]">
